...
pygame.init()
screen = pygame.pygame.display.set_mode([720, 720])
...
def get_dist_btw_pos(pos0, pos1):
    """
    Get distanve between 2mouse position.
    """
    x = abs(pos0[0] - pos1[0])
    y = abs(pos0[1] - pos1[1])
...
def get_angle_btw_line(pos0, pos1, posref):
    ...
    _dot = (ax * bx) + (ay * by)
    # Get mangitude of pos0 and pos1.
...
"""
Compute the waypoints (distanve and angle).
"""
path_dist_cm = []
path_dist_px = []
path_angle = []
